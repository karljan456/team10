                ...
                <article>
                    <div class="container text-center text-dark article-container px-4  justify-content-center">
                        <div class="row">
                            <div class="article-grid latest-box col-lg-4 col-md-12 justify-content-center">
                                <a href="posts/post.php?slug=Lorem-Ipsum"><img class="img-fluid" src="./assets/images/andy_robertson.png"
                            ...
                            <div class="article-grid  latest-box  col-lg-4 col-md-12 justify-content-center">
                                <a href="posts/post.php?slug=Lorem-Ipsum"><img class="img-fluid" src="./assets/images/FA_youth_cup.png"
                                        alt="FA CUP picture">
                                    <h4>
                            ...
                            <div class="article-grid  latest-box  col-lg-4 col-md-12 justify-content-center">
                                <a href="posts/post.php?slug=Lorem-Ipsum"><img class="img-fluid" src="./assets/images/matt_beard.png"
                    ...
                    <div class="container article-grid-2nd text-center text-dark article-container2 px-4 ">
                        <div class="row">
                            <div class=" article-grid latest-box col-lg-4 col-md-12">
                                <a href="posts/post.php?slug=Lorem-Ipsum"><img class="img-fluid" src="./assets/images/vandijk.png"
                                        alt="Virgil smiling">
                                    <h4>
                            ...
                            <div class="  article-grid latest-box col-lg-4 col-md-12">
                                <a href="posts/post.php?slug=Lorem-Ipsum"><img class="img-fluid" src="./assets/images/shankly.png"
                            ...
                            <div class=" article-grid latest-box col-lg-4 col-md-12">
                                <a href="posts/post.php?slug=Lorem-Ipsum"><img class="img-fluid" src="./assets/images/xabi.png"
                    ...
                    <div class="container">
                        <div class="row neverforget">
                            <div class="col-md-6">
                                <img class="img-fluid" src="./assets/images/neverforget.png" alt="neverforget">
                            </div>
                            <div class="col-md-6">
                                <img class="img-fluid" src="./assets/images/inmemoria.png" alt="inmemoria">
                            </div>
                        </div>
                    </div>
                </article>
